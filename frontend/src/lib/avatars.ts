// Paleta unificada de cores para avatares — alinhada entre Board, Planning e Comments.
// Usa hash determinístico sobre um identificador (preferencialmente publicId do User, ou o
// name quando não disponível) para garantir cor consistente entre renders e tabs.
