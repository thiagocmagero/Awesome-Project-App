    ...
    <AuthProvider>
      ...
      <Routes>
        ...
        <Route path="/:locale" element={<LocaleGuard />}>
          ...
          {/* Workspace landing dentro do locale (autenticado, sem ws no path) */}
          <Route index element={<RedirectToDefaultWorkspace />} />
        </Route>

        {/* ── Sem locale no path → injectar ─────────────────────────────── */}
